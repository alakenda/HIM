...
@property(copy,readwrite)	NSString*			macaddress;				    // mac地址
// ネットワーク
...
@property(assign,readwrite) NSDictionary*       emotionImgDic;              // 表情对应文件的字典emotionstr.plist
